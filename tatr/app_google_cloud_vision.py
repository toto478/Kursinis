...
def apply_ocr(cell_coordinates, cropped_table):
    ...
    for idx, row in enumerate(cell_coordinates):
        ...
        for cell in row["cells"]:
            ...
            cell_image.save(img_byte_arr, format='PNG')
...
root_folder = r'C:\Users\Simas\Desktop\Ataskaitos\kursinis\tatr-demo\Processed Images - google'  # Path to the folder containing subfolders with images
